    ...
    <form id="form1" runat="server">
        <center>
            ...
            <asp:TextBox ID="TextBox1" runat="server" Height="100px" Width="403px" TextMode="MultiLine"></asp:TextBox>
                ...
                <br />
                <%--YOUR DATA--%>
                <asp:Label ID="Label7" runat="server" Text="YOUR DATA :"></asp:Label>
                <br />
                <br />
                <asp:Label ID="Label8" runat="server" Text="Name" ForeColor="#0033CC"></asp:Label>
                &nbsp;:
                <asp:Label ID="EnteredNameLabel" runat="server" ForeColor="Black"></asp:Label>
                <br />
                <br />

                <asp:Label ID="Label9" runat="server" Text="Email" ForeColor="#0033CC"></asp:Label>
                &nbsp;:
                <asp:Label ID="EnteredEmailLabel" runat="server" ForeColor="Black"></asp:Label>
                <br />
                <br />

                <asp:Label ID="Label10" runat="server" Text="ID" ForeColor="#0033CC"></asp:Label>
                &nbsp;:
                <asp:Label ID="EnteredIdLabel" runat="server" ForeColor="Black"></asp:Label>
                <br />
                <br />

                <asp:Label ID="Label11" runat="server" Text="Gender" ForeColor="#0033CC"></asp:Label>
                &nbsp;:
                <asp:Label ID="EnteredGenderLabel" runat="server" ForeColor="Black"></asp:Label>
                <br />
                <br />

                <asp:Label ID="Label12" runat="server" Text="Courses" ForeColor="#0033CC"></asp:Label>
                &nbsp;:
                <asp:Label ID="EnteredCoursesLabel" runat="server" ForeColor="Black"></asp:Label>
                <br />
                <br />

                <asp:Label ID="Label13" runat="server" Text="Description" ForeColor="#0033CC"></asp:Label>
                &nbsp;:
                <asp:Label ID="EnteredDescriptionLabel" runat="server" ForeColor="Black"></asp:Label>
